...
<p>Currently, I'm working with <b>Shared Services Canada</b> as an <b>Information Technology Analyst Co-op Student (4 months)</b>, where I'm gaining exposure into the fundamentals of technical support work (Service Manager 9, Excel, Python scripting for automation, Microsoft Azure for user state management). Upon completion, in January 2026, I'll be joining the <b>Canadian Institute for Health Information</b> as an <b>Applied Cloud Architecture Developer intern</b> for a 4-month internship.</p>
